    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('used_space', models.FloatField(default=0.0, verbose_name='消耗空间')),
                ('username', models.CharField(max_length=150, unique=True, verbose_name='用户名')),
                ('email', models.EmailField(max_length=254, unique=True, verbose_name='邮箱')),
                ('password', models.CharField(blank=True, max_length=255, verbose_name='密码')),
                ('avatar', models.ImageField(blank=True, default='avatar/default.png', null=True, upload_to='avatars/', verbose_name='头像')),
                ...
                ('membership', models.CharField(choices=[('free', '免费会员'), ('silver', '银牌会员'), ('gold', '金牌会员')], default='free', max_length=20, verbose_name='会员权限')),
            ],
            options={
                'verbose_name': '用户',
